...
export default {
  ...
  created() {
    this.$store.commit("cart/SET_PAYMENT_METHOD", 'cash');
...
.payment-method .payment-selection-content {
...
.payment-method .payment-selection-content .item {
  font-family: "Inter";
  font-style: normal;
  font-weight: 500;
  font-size: 14px;
...
.payment-method .payment-selection-content .item.is-selected {
  background: #1c8b71;
  border-radius: 80px;
  color: #fff;
}

.payment-method .promotion-code-content {
  padding-top: 1rem;
  border-top: 1px solid #e6e6e6;
  margin-top: 1rem;
}

.payment-method p.promotion-code {
  font-family: "Inter";
  font-style: normal;
  font-weight: 400;
  font-size: 14px;
